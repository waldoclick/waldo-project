import { bq as p } from "./BK8sApmn.js";
try {
  let a =
      typeof window < "u"
        ? window
  ...
  t &&
    ...
    (a._sentryDebugIds[t] = "f9bc345b-7cbc-4bfb-a7f6-c3695ba51649"),
    (a._sentryDebugIdIdentifier =
      "sentry-dbid-f9bc345b-7cbc-4bfb-a7f6-c3695ba51649"));
} catch {}
var o = { exports: {} },
  m = o.exports,
  f;
      ...
      (function (a, t) {
        (function (s, c, i) {
          ...
          function i(u, e) {
            ...
            var h = c[e.locale] || {},
              d = e.replacement === void 0 ? "-" : e.replacement,
              y = e.trim === void 0 ? !0 : e.trim,
              r = u
                .normalize()
                .split("")
                .reduce(function (g, l) {
                  ...
                  return (
                    ...
                    n === void 0 && (n = l),
                    n === d && (n = " "),
                    g + n.replace(e.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "")
                  );
                }, "");
            return (
              e.strict && (r = r.replace(/[^A-Za-z0-9\s]/g, "")),
              y && (r = r.trim()),
              (r = r.replace(/\s+/g, d)),
              e.lower && (r = r.toLowerCase()),
              r
            );
          }
          return (
...
var A = E();
const b = p(A),
  S = () => ({ toSlug: (t) => b(t, { lower: !0, strict: !0, trim: !0 }) });
export { S as u };
//# sourceMappingURL=DQVnk6X6.js.map
