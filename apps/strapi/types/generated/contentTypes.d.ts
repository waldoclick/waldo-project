...
export interface ApiAdFeaturedReservationAdFeaturedReservation
  extends Struct.CollectionTypeSchema {
  collectionName: "ad_featured_reservations";
  info: {
    description: "";
    displayName: "AdFeaturedReservation";
    pluralName: "ad-featured-reservations";
    singularName: "ad-featured-reservation";
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ad: Schema.Attribute.Relation<"oneToOne", "api::ad.ad">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
...
export interface ApiAdPackAdPack extends Struct.CollectionTypeSchema {
  collectionName: "ad_packs";
  info: {
    description: "";
    displayName: "AdPack";
    pluralName: "ad-packs";
    singularName: "ad-pack";
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiAdReservationAdReservation
  extends Struct.CollectionTypeSchema {
  collectionName: "ad_reservations";
  info: {
    description: "";
    displayName: "AdReservation";
    pluralName: "ad-reservations";
    singularName: "ad-reservation";
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiAdAd extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ad_featured_reservation: Schema.Attribute.Relation<
      ...
      "api::ad-featured-reservation.ad-featured-reservation"
    >;
    ad_reservation: Schema.Attribute.Relation<
      "oneToOne",
      "api::ad-reservation.ad-reservation"
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buy_order: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    document_details: Schema.Attribute.JSON;
    document_response: Schema.Attribute.JSON;
    is_invoice: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiRemainingRemaining extends Struct.CollectionTypeSchema {
  collectionName: "remainings";
  info: {
    description: "";
    displayName: "Remaining";
    pluralName: "remainings";
    singularName: "remaining";
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSuscriptionSuscription extends Struct.CollectionTypeSchema {
  collectionName: "suscriptions";
  info: {
    description: "Generic subscription management";
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nextPaymentDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    providerData: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ad_featured_reservations: Schema.Attribute.Relation<
      "oneToMany",
      "api::ad-featured-reservation.ad-featured-reservation"
    >;
    ad_reservations: Schema.Attribute.Relation<
      "oneToMany",
      "api::ad-reservation.ad-reservation"
    >;
    address: Schema.Attribute.String;
    address_number: Schema.Attribute.Integer;
    ads: Schema.Attribute.Relation<"oneToMany", "api::ad.ad">;
    avatar: Schema.Attribute.Media<"images">;
    birthdate: Schema.Attribute.Date;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    business_address: Schema.Attribute.String;
    business_address_number: Schema.Attribute.Integer;
    business_commune: Schema.Attribute.Relation<
      "oneToOne",
      "api::commune.commune"
    >;
    business_name: Schema.Attribute.String;
    business_postal_code: Schema.Attribute.String;
    business_region: Schema.Attribute.Relation<
      "oneToOne",
      "api::region.region"
    >;
    business_rut: Schema.Attribute.String;
    ...
    flow_customer_data: Schema.Attribute.JSON & Schema.Attribute.Private;
    is_company: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    last_username_change: Schema.Attribute.Date & Schema.Attribute.Private;
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::ad-featured-reservation.ad-featured-reservation": ApiAdFeaturedReservationAdFeaturedReservation;
