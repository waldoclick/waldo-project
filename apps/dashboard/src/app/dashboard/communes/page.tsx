...
export default function CommunesPage() {
  ...
  const fetchCommunes = useCallback(async () => {
    try {
      ...
      console.log('Communes response:', response);
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Gestiona las comunas del sistema
            </p>
          </div>
          <Button onClick={() => router.push('/dashboard/communes/new')}>
        ...
        <Card className="shadow-none">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Lista de Comunas</CardTitle>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end space-x-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                router.push(`/dashboard/communes/${commune.id}`)
                              }
                            ...
                            <Button
                              ...
                              onClick={() =>
                                router.push(
                                  `/dashboard/communes/${commune.id}/edit`
                                )
                              }
                              className="h-8 w-8 p-0"
                            >
