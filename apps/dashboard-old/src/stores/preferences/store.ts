...
const defaultPacksPreferences: PacksPreferences = {
  pageSize: 25,
  sortBy: 'name:asc',
  searchTerm: '',
};

const defaultRegionsPreferences: RegionsPreferences = {
  pageSize: 25,
  sortBy: 'name:asc',
  searchTerm: '',
};
...
export const usePreferencesStore = create<PreferencesState>()(
  persist(
    (set) => ({
      ...
      setPacksPreferences: (preferences: Partial<PacksPreferences>) => {
        set((state) => ({
          packs: {
            ...state.packs,
            ...preferences,
      ...
      setRegionsPreferences: (preferences: Partial<RegionsPreferences>) => {
        set((state) => ({
          regions: {
            ...state.regions,
            ...preferences,
