...
- [ ] **PAGE-01**: `preguntas-frecuentes.vue` realiza exactamente 1 llamada a la API al cargar la página (actualmente hace 2)
- [ ] **PAGE-02**: `mis-anuncios.vue` realiza exactamente 2 llamadas a la API al cargar la página — 1 para tab counts y 1 para ads — (actualmente hace 6)
