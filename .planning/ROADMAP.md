...
Plans:
- [ ] 104-01-PLAN.md — Backend: deleteInscription, ProCancellationService, cancel endpoint, cron Step 4 sweep, tests
...
| 104. Cancellation + Account Management | v1.46 | 0/2 | Not started | - |
