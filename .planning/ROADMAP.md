...
- [ ] **Phase 079: Website Verify Flow + MJML Fix** — Close the v1.36 carry-forward: execute the website 2-step verify UX + fix the "5 minutos" copy error in verification-code.mjml
- [ ] **Phase 080: Password Reset MJML + Context Routing** — Replace Strapi's plain-text password reset with a branded MJML email that routes to the correct app's reset page based on the requester's role
