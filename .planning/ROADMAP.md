...
**Plans:** 4 plans (waves: 1 → 126-01, 126-02, 126-03; 2 → 126-04)
...
- [ ] 126-02-PLAN.md — SEC-MASSASSIGN-ADS (HIGH): `protect-ad-fields` global middleware stripping privileged ad fields from POST/PUT `/api/ads`
- [ ] 126-03-PLAN.md — SEC-IDOR-FREEAD (MEDIUM): ownership assertion in `free-ad.service.ts` before publish/relink/re-date
