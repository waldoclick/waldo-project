...
Plans:
- [ ] 10-01-PLAN.md — Header público: showMenu default flip + :show-menu=false en 19 páginas de flujo + position:fixed + z-index:50 + transition cubic-bezier (HDR-PUBLIC)
